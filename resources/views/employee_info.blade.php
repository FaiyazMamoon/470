            ...
            <div class="col-md-8">
                <div class="card" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 700px;">
                    ...
                    <div class="card-body" style="font-family: 'ITC Legacy Sans Pro Condensed Bold';">
                        <form action="{{ route('employee.info.search') }}" method="GET">
                            @csrf
                            <div class="form-group">
                                <label for="employeeName">Search from your Employees:</label>
                        ...
                        <!--Tale of employees-->
                        @if (isset($matchingEmployees) && $matchingEmployees->count() > 0)
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Name</th>
